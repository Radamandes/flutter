  ...
  void salvarFormulario() {
    setState(() {
      if (formKey.currentState != null) {
        ...
        registro.idade = formKey.currentState!.fields['idade']!.value.toString();
        registro.telefone = formKey.currentState!.fields['telefone']!.value.toString();
        registro.email = formKey.currentState!.fields['email']!.value.toString();
